...
#define FIRST_DECLARATION FIRST_DECLARATION_BASE,                           \
    ...
    TK_UINT, TK_UVEC2, TK_UVEC3, TK_UVEC4, TK_FLOAT2, TK_FLOAT3, TK_FLOAT4, \
    TK_MATRIX2, TK_MATRIX3, TK_MATRIX4, TK_SAMPLER_2D, TK_SAMPLER_CUBE,     \
    TK_IN, TK_OUT, TK_ATTRIBUTE, TK_UNIFORM, TK_VARYING, TK_LAYOUT, TK_LOCATION
#else
#define FIRST_DECLARATION FIRST_DECLARATION_BASE
#endif // LANG_GLSL
...
#define FIRST_EXPRESSION FIRST_EXPRESSION_BASE,                                       \
    ...
    TK_UINT, TK_UVEC2, TK_UVEC3, TK_UVEC4, TK_FLOAT, TK_FLOAT2, TK_FLOAT3, TK_FLOAT4, \
    TK_MATRIX2, TK_MATRIX3, TK_MATRIX4, TK_SAMPLER_2D, TK_SAMPLER_CUBE
#else
#define FIRST_EXPRESSION FIRST_EXPRESSION_BASE
#endif // LANG_GLSL
